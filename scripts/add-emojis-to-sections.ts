...
async function addEmojisToSections() {
  try {
    console.log('🎨 Adding emojis back to homepage sections...\n')
    ...
    const updatedContentBlocks = homepage.contentBlocks.map((block: any) => {
      ...
      if (block._type === 'pageSection' && block.title === 'Live Elpriser Time for Time: Se Dagens Spotpriser Nu') {
        updatedSections++
        console.log('📝 Adding emojis to "Live Elpriser" section...')
      ...
      if (block._type === 'pageSection' && block.title === 'Hvad Koster Strømmen? Beregn Dit Elforbrug Her') {
        updatedSections++
        console.log('📝 Adding emojis to "Hvad Koster Strømmen" section...')
      ...
      if (block._type === 'pageSection' && block.title === 'Få en Ladeboks og Oplad Din Elbil Billigere og Grønnere') {
        updatedSections++
        console.log('📝 Adding emojis to "Få en Ladeboks" section...')
    ...
    if (updatedSections > 0) {
      ...
      console.log(`\n✅ Successfully added emojis to ${updatedSections} sections!`)
    } else {
