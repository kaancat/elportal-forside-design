...
async function createLadeboksPage() {
  try {
    console.log('Creating Ladeboks page with existing products...')
    ...
    const ladeboksPage = {
      ...
      contentBlocks: [
        ...
        // Charging Box Showcase - Using existing product IDs
        {
          ...
          content: [
            ...
            },
            {
              ...
              children: [
                {
                  _type: 'span',
                  text: 'Dynamisk lastbalancering sikrer at din hovedsikring ikke overbelastes når du lader. Ladeboksen overvåger husets samlede elforbrug og justerer automatisk ladeeffekten. Dette er især vigtigt hvis du har begrænsret kapacitet i din el-installation eller hvis flere biler skal lade samtidigt.'
                }
              ]
            },
            {
    ...
    console.error('Error creating Ladeboks page:', error)
    if (error.response) {
