        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl mb-2">1. Indtast dine oplysninger</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl mb-2">2. Sammenlign tilbud</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-xl mb-2">3. Vælg og skift nemt</h3>
              <p className="text-gray-600">
