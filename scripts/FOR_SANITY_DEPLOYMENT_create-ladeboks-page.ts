...
// 3. Run: npx tsx FOR_SANITY_DEPLOYMENT_create-ladeboks-page.ts
...
if (!process.env.SANITY_API_TOKEN) {
  ...
  console.error('Make sure you have a .env file with SANITY_API_TOKEN in the sanityelpriscms project')
  process.exit(1)
}
